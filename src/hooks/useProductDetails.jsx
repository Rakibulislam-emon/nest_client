...
//     params: {
//       query: productName,
//       client_id:  `${import.meta.env.UNSPLASH_API_URL}`, 
//       per_page: 4, // Number of related images to fetch
//     },
//   });
...
//   return { data, isLoading, isError, error }; // Return all query-related states
// }
...
export default function useProductDetails(initialData) {
  ...
  const { data: relatedImages, isLoading: imagesLoading, isError: imagesError } = useQuery({
