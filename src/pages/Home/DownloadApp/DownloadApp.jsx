...
export default function DownloadApp() {
  // #ffc107
  return (
    <main className="bg-[#d8f1e5]   max-w-screen-2xl mx-auto  max-sm:h-[485px] h-[460px] lg:h-[456px] rounded-3xl mt-4 flex flex-col lg:flex-row justify-evenly items-center  p-8">
