  ...
  return (
    <main className="mt-10 lg:h-[470px] mb-20 lg:max-w-screen-2xl mx-auto flex flex-col md:flex-row gap-y-10 gap-x-10">
      <div className="relative w-full md:w-1/2 group overflow-hidden rounded-[2rem] shadow-premium bg-neutral-200">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[92%] sm:w-[85%] lg:max-w-xl text-white p-6 md:p-10 lg:p-14 bg-white/10 backdrop-blur-xl rounded-[2rem] md:rounded-[3rem] border border-white/20 shadow-2xl transform transition-all duration-700 group-hover:bg-white/20 flex flex-col items-center text-center">
          <h2 className="text-2xl md:text-5xl lg:text-7xl font-bold font-heading mb-3 md:mb-6 leading-tight tracking-tight drop-shadow-lg">
            {adData[0].title}
          </h2>
          <p className="text-sm md:text-2xl lg:text-3xl font-bold text-amber-400 mb-6 md:mb-10 tracking-[0.2em] uppercase">
            {adData[0].discount}
          </p>
          <Link to={"/shop"}>
            <Button
